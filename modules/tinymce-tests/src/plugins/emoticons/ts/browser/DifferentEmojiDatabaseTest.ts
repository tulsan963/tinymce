...
describe('browser.tinymce.plugins.emoticons.DifferentEmojiDatabaseTest', () => {
  ...
  it('TBA: Loading databases from different urls ', async () => {
    await pTestEditorWithSettings([ 'All', 'People' ], '/project/@tinymce/tests/src/plugins/emoticons/js/test-emojis.js');
    await pTestEditorWithSettings([ 'All', 'Travel and Places' ], '/project/@tinymce/tests/src/plugins/emoticons/js/test-emojis-alt.js');
  });
});
