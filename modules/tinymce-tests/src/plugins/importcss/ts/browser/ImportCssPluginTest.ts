...
describe('browser.tinymce.plugins.importcss.ImportCssTest', () => {
  ...
  it('TBA: content_css with one file, append default', () => pTestEditorWithSettings(
    ...
    {
      content_css: [ '/project/@tinymce/tests/src/plugins/importcss/css/basic.css' ],
  ...
  it('TBA: content_css with multiple files, append true', () => pTestEditorWithSettings(
    ...
    {
      content_css: [
        '/project/@tinymce/tests/src/plugins/importcss/css/basic.css',
        '/project/@tinymce/tests/src/plugins/importcss/css/advanced.css',
        '/project/@tinymce/tests/src/plugins/importcss/css/other-adv.css'
      ],
      importcss_append: true
    }
  ));
